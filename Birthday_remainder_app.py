...
def Remind(root): # this is menu bar Remind setting
    ...
    l = LabelFrame(win, text = '',padx = 5,pady=5)
    ...
    v4 = IntVar()
    v5 = IntVar()
    Checkbutton(l, text='Today',variable=v1,onvalue =1,offvalue=0).grid(row=1,column=0) # radiobutton or message cliiked
    Checkbutton(l, text='1 Day before', variable=v2,onvalue=2, offvalue=0).grid(row=2,column=0)
    Checkbutton(l, text='2 Day before', variable=v3, onvalue=3, offvalue=0).grid(row=3,column=0)
    Checkbutton(l, text='3 Day before', variable=v4, onvalue=4, offvalue=0).grid(row=4,column=0)
    Checkbutton(l, text='1 Week before', variable=v5, onvalue=5, offvalue=0).grid(row=5,column=0)
    ...
    Button(l, text='Save', command=save_Remind).grid(row=6,column=0,padx = 10, pady= 10)
    Button(l, text='Return to home', command=home).grid(row=6,column=1,padx = 10, pady= 10)
    win.mainloop()
...
def main(root,first_time=1):
    ...
    l = LabelFrame(root,text = '',padx=10,pady=10)
    l.pack(padx=10,pady=10)
    title = Label(l, text='Welcome to Birthday remainder !', width=55, font=('Times New Roman', 25, ''), fg='blue')
    title.pack()
    ...
    bv.pack(pady=10)
    ba = Button(bl,text = 'Add the Birthday date !',font=('Times New Roman', 15, ''), command = lambda : Abd(root))
    ba.pack(pady=10)
    br = Button(bl,text = 'Remove the Birthday date !',font=('Times New Roman', 15, ''), command = lambda : Rbd(root))
    br.pack(pady=10)
    ...
    thism = Label(l, text=f"{months} Month Bithday list", width=55, font=('Times New Roman', 15,''), fg='chocolate')
    thism.pack()
...
def Vab(root):
    ...
    win.iconbitmap('code.ico')
    hl = LabelFrame(win, text='', padx=5, pady=5)
    hl.pack(padx=10, pady=10)
    l = LabelFrame(hl, text='', padx=5, pady=5)
    l.pack(padx=10, pady=10)
    ...
    def home():
        ...
        root = Tk()
        main(root,first_time=2)
    Button(hl, text='Return to home',font=('Times New Roman', 13, ''), command=home).pack()
    root.mainloop()
...
def Abd(root): # Adding Birthday date
    ...
    Label(l, text="Enter day / month / year:",
          font=("Times New Roman", 10)).grid(row=2, column=0, padx=30, pady=25)
    ...
    def home():
        ...
        root = Tk()
        main(root,first_time=2)
    Button(l,text= 'Save',command=save).grid(row=3,column=0)
    Button(l, text='Return to home', command=home).grid(row=3, column=1)
    root.mainloop()
...
def Rbd(root):
    ...
    Label(l, text="Remove the Birthday date and name select:",
          font=("Times New Roman", 11)).grid(row=1, column=0, padx=30, pady=25)
    with open('all_brithday_list.txt', 'r') as f:
        als = f.readlines()
        #print(als)
        al = []
    ...
    Button(l, text='Delete', command=delete).grid(row=3,column=0)
    Button(l, text='Return to home', command=home).grid(row=3,column=1)
    root.mainloop()
